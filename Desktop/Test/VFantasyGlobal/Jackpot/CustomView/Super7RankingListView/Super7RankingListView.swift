...
class Super7RankingListView: UIView {
    ...
    func loadViewFromXIB() {
        let views = Bundle.sdkBundler()?.loadNibNamed("Super7RankingListView", owner: self, options: nil)
    ...
    func setup() {
        ivMineLogo.roundCorners(.allCorners, radius: 8.0)
...
extension Super7RankingListView: UITableViewDataSource {
...
extension Super7RankingListView: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        super7ViewController.viewedTeam = myTeam
        self.rootView.navigationController?.pushViewController(super7ViewController, animated: true)
    }
}

extension Super7RankingListView: RankingGlobalView {
...
extension Super7RankingListView: UIScrollViewDelegate {
...
extension Super7RankingListView : UICollectionViewDelegate, UICollectionViewDataSource {
...
extension Super7RankingListView : UICollectionViewDelegateFlowLayout {

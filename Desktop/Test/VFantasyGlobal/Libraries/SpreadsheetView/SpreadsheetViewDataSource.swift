...
protocol SpreadsheetViewDataSource: class {
...
extension SpreadsheetViewDataSource {
    func spreadsheetView(_ spreadsheetView: SpreadsheetView, cellForItemAt indexPath: IndexPath) -> Cell? { return nil }
    func mergedCells(in spreadsheetView: SpreadsheetView) -> [CellRange] { return [] }
    func frozenColumns(in spreadsheetView: SpreadsheetView) -> Int { return 0 }
    func frozenRows(in spreadsheetView: SpreadsheetView) -> Int { return 0 }
}

...
class SpreadsheetView: UIView {
    ...
    var intercellSpacing = CGSize(width: 1, height: 1)
    var gridStyle: GridStyle = .solid(width: 1, color: .lightGray)
    ...
    var circularScrolling: CircularScrollingConfiguration = CircularScrolling.Configuration.none {
        didSet {
    ...
    var stickyRowHeader: Bool = false
    ...
    var stickyColumnHeader: Bool = false
    ...
    var sourceTableView: UIScrollView {
        return tableView
    }
    ...
    private func setup() {
        ...
        overlayView.frame = .init(x: 100, y: 44, width: bounds.width, height: bounds.height)
...
//        super.addSubview(overlayView)
    ...
    func register(_ cellClass: Cell.Type, forCellWithReuseIdentifier identifier: String) {
    ...
    func scrollToItem(at indexPath: IndexPath, at scrollPosition: ScrollPosition, animated: Bool) {
    ...
    func cellsForItem(at indexPath: IndexPath) -> [Cell] {
        var cells = [Cell]()

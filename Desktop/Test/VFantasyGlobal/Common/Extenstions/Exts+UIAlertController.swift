...
extension UIAlertController {
    ...
    func show(animated: Bool = true, vibrate: Bool = false, style: UIBlurEffect.Style? = nil, completion: (() -> Void)? = nil) {
        ...
        DispatchQueue.main.async {
            guard  let controler = UIApplication.getTopController() else {return}
            controler.present(self, animated: animated, completion: completion)
            if vibrate {

...
class Throttle<Argument> {
    
    /// The type of the action.
    typealias ThrottleAction = (Argument) -> Void
    ...
    init(interval: TimeInterval, action: @escaping ThrottleAction) {
    ...
    func schedule(with value: Argument) {
        cancel()

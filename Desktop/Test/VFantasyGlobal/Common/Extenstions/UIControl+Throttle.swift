...
extension UIControl {
    ...
    func throttle<T: UIControl>(_ event: UIControl.Event, interval: TimeInterval, handler: @escaping (T, UIEvent?) -> Void) {
    ...
    /// - parameter interval: The time interval to wait before performing the action
    /// - parameter handler:  The action which will be executed when the time itnerval expires.
    func throttle<T: UIControl>(_ event: UIControl.Event, interval: TimeInterval, handler: @escaping (T) -> Void) {
    ...
    /// - parameter interval: The time interval to wait before performing the action
    /// - parameter handler:  The action which will be executed when the time itnerval expires.
    func throttle(_ event: UIControl.Event, interval: TimeInterval, handler: @escaping () -> Void) {
        let throttle = Throttle(interval: interval, action: handler)
    ...
    func removeThrottle(for event: UIControl.Event) {

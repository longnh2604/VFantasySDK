...
extension UIView {
    func mySafeAreaInsets() -> UIEdgeInsets {
    ...
    func drawRound(radius: CGFloat, _ masksToBounds: Bool = true) {
        self.layer.cornerRadius = radius
        self.layer.masksToBounds = masksToBounds
    }
    
    func drawBorder(radius: CGFloat, borderWidth: CGFloat, borderColor: UIColor) {
        self.drawRound(radius: radius)
        self.layer.borderWidth = borderWidth
        self.layer.borderColor = borderColor.cgColor
    }
    
    func createFromNib() -> [Any]? {
        return Bundle.sdkBundler()?.loadNibNamed(self.className, owner: self, options: nil)
    }
    ...
    func roundCornersFix(width: CGFloat, _ corners: UIRectCorner, _ radius: CGFloat) {
...
extension UIView {
    class func fromNib<T: UIView>() -> T {
        return Bundle.sdkBundler()!.loadNibNamed(String(describing: T.self), owner: nil, options: nil)![0] as! T
    }
    @IBInspectable
    ...
    func gradientCricleBorder(colors: [UIColor]){
    ...
    /**/
    func gradient(colors: [UIColor],isCircle:Bool,direction: UIViewGradientDirection) -> CAGradientLayer {
    ...
    func shadowView(color:UIColor, size:CGSize, radius:CGFloat, opacity:Float)  {
    ...
    func shadowView(color:UIColor, cornerRadius:CGFloat, size:CGSize, shadowRadius:CGFloat, cornerRadiusShadow:CGFloat, clipToBounds: Bool = false) {
